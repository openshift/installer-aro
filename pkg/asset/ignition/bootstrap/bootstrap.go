...
func (a *Bootstrap) Generate(dependencies asset.Parents) error {
	...
	dnsmasqIgnConfig, err := dnsmasq.Ignition3Config(installConfig.Config.ClusterDomain(), aroDNSConfig.APIIntIP, aroDNSConfig.IngressIP, aroDNSConfig.ProxyDomains, aroDNSConfig.PrivateEndpointIP)
	if err != nil {
		return err
	}
