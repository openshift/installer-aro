...
func (m *MockAPI) GetPublicDNSZone(ctx context.Context, project, baseDomain string) (*v10.ManagedZone, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetRecordSets(ctx context.Context, project, zone string) ([]*v10.ResourceRecordSet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRecordSets", ctx, project, zone)
	ret0, _ := ret[0].([]*v10.ResourceRecordSet)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
