...
import (
	...
	v10 "google.golang.org/api/compute/v1"
	v11 "google.golang.org/api/dns/v1"
...
func (m *MockAPI) GetDNSZone(ctx context.Context, project, baseDomain string, isPublic bool) (*v11.ManagedZone, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetDNSZone", ctx, project, baseDomain, isPublic)
	ret0, _ := ret[0].(*v11.ManagedZone)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) GetDNSZoneByName(ctx context.Context, project, zoneName string) (*v11.ManagedZone, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetImage(ctx context.Context, name, project string) (*v10.Image, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetMachineType(ctx context.Context, project, zone, machineType string) (*v10.MachineType, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMachineType", ctx, project, zone, machineType)
	ret0, _ := ret[0].(*v10.MachineType)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) GetMachineTypeWithZones(ctx context.Context, project, region, machineType string) (*v10.MachineType, sets.Set[string], error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetNetwork(ctx context.Context, network, project string) (*v10.Network, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetProjectByID(ctx context.Context, project string) (*v1.Project, error) {
	m.ctrl.T.Helper()
...
func (m *MockAPI) GetRecordSets(ctx context.Context, project, zone string) ([]*v11.ResourceRecordSet, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRecordSets", ctx, project, zone)
	ret0, _ := ret[0].([]*v11.ResourceRecordSet)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) GetSubnetworks(ctx context.Context, network, project, region string) ([]*v10.Subnetwork, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSubnetworks", ctx, network, project, region)
	ret0, _ := ret[0].([]*v10.Subnetwork)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAPI) GetZones(ctx context.Context, project, filter string) ([]*v10.Zone, error) {
	m.ctrl.T.Helper()
