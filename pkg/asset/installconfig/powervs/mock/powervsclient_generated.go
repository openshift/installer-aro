...
func (mr *MockAPIMockRecorder) GetDatacenterCapabilities(ctx, zone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) GetWorkspaceCapabilities(ctx, svcInsID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAPIMockRecorder) ServiceInstanceIDToCRN(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
