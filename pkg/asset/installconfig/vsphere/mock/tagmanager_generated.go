...
//
//	mockgen -source=./validation.go -destination=./mock/tagmanager_generated.go -package=mock
//
...
func (mr *MockTagManagerMockRecorder) GetAttachedTags(ctx, ref any) *gomock.Call {
...
func (mr *MockTagManagerMockRecorder) GetAttachedTagsOnObjects(ctx, objectID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagManagerMockRecorder) GetCategories(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagManagerMockRecorder) GetCategory(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagManagerMockRecorder) GetTagsForCategory(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTagManagerMockRecorder) ListCategories(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
