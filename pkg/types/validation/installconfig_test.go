...
func TestValidateInstallConfig(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			expectedError: `^HTTPProxy: Invalid value: "http://bad%20uri": parse "?http://bad%20uri"?: invalid URL escape "%20"$`,
		},
		{
			...
			expectedError: `^HTTPSProxy: Invalid value: "https://bad%20uri": parse "?https://bad%20uri"?: invalid URL escape "%20"$`,
		},
		{
